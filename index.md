...
address: "E3B 217 (8SCO 217), Macquarie University, Sydney, Australia"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Xavier Ho", "Anastasios Papaioannou", "James Tocknell", "Wilfred Gee"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Cormac Purcell", "Gustavo Thomas", "Malcom Ramsay"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: http://pad.software-carpentry.org/2018-07-03-resbaz-python-advanced            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<div id="python"> {% comment %} Start of 'pytest' section. Remove the third paragraph if
...
<div id="pytest"> {% comment %} Start of 'pytest' section. {% endcomment %}
  <h3>pytest</h3>
...
</div> {% comment %} End of 'pytest' section. {% endcomment %}
